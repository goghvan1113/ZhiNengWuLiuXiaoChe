...
#define OLED_DC_Clr() GPIO_ResetBits(GPIOE,GPIO_Pin_1)//DC
#define OLED_DC_Set() GPIO_SetBits(GPIOE,GPIO_Pin_1)
 		     
#define OLED_CS_Clr()  GPIO_ResetBits(GPIOE,GPIO_Pin_0)//CS
#define OLED_CS_Set()  GPIO_SetBits(GPIOE,GPIO_Pin_0)
