...
#define MOT_MaxSpeedAll	375.0f			//电机的最快转速，以最慢的电机为准

#define MOT_MinSpeedPulse_1		1000  //300.0f		//输出脉宽小于这个值时，速度即为MOT_MinSpeed_1
